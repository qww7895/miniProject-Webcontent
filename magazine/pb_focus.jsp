...
<body>
   <div id="wrap" class="magazine_list pb_focus">
	...
	<div id="container">
		<aside>
			<ul>
				...
				<li class="on"><a href="pb_focus.mag">PB FOCUS</a></li>
		...
		<div class="rolling_style_04">
			<div class="ytb_wrap">
				<div class="ytb">
					<div class="main_ytubeBox" style="position: relative;width:100%;padding-bottom:56%;"><iframe style="position:absolute; left:0; top:0; width:100%;height:100%;" src="https://www.youtube.com/embed/ztpNsAMqUuY?rel=0" frameborder="0" allowfullscreen=""></iframe></div>
				</div>
			</div>
			<ul id="magazine_slide">
				
				<!-- <li><a href="https://www.paris.co.kr/magazine/pb_focus_view.jsp?id=23&"><img src="data/file/dffd0503c2b01e7d3565cf6c3a6fa730.jpg" alt="PB FOCUS" /></a></li> -->
		...
		<div class="list_style_01">
			<ul>
				...
				<li>
					<a href="pb_focus_view.jsp?id=23&">
						<img src="data/magazine/PB_01_magazine_list.png" alt="아침 한 끼로 누리는 여유, 파리바게뜨에서 유럽의 아침을 맛보다." />
						<p>
							<span>[신제품]</span>아침 한 끼로 누리는 여유, 파리바게뜨에서 유럽의 아침을 맛보다.
						</p>
					</a>
				</li>
				
				<li>
					<a href="pb_focus_view.jsp?id=11&">
						<img src="data/magazine/magazine_new1.jpg" alt="빵, 건강을 입고 식탁으로 오르다." />
						<p>
							<span>[집중제품]</span>빵, 건강을 입고 식탁으로 오르다.
						</p>
					</a>
				</li>

	...
	<div id="container">
		<aside>
			<ul>
				...
				<li class="on"><a href="pb_story.mag">PB STORY</a></li>
		...
		<div class="rolling_style_04">
			<ul id="magazine_slide">
				...
				<li><a href="https://www.paris.co.kr/magazine/pb_story_view.jsp?id=8&"><img src="data/file/a38dfb0f9cf563863942acf079a69c7f.jpg" alt="PB_STORY 작은빵집" /></a></li>
		...
		<div class="list_style_01">
			<ul>
				...
				<li>
					<a href="pb_story_view.jsp?id=24&">
						<img src="data/magazine/pc_PB-STORY_주식카페_list배너_380x186.jpg" alt="주식(主食)부터 카페문화까지" />
						<p>
							<span>[브랜드스토리]</span>주식(主食)부터 카페문화까지
						</p>
					</a>
				</li>
				
				<li>
					<a href="pb_story_view.jsp?id=8&">
						<img src="data/magazine/pc_PB-STORY_작은빵집_list배너_380x186.jpg" alt="우리의 일상이 된 작은 빵집" />
						<p>
							<span>[브랜드스토리]</span>우리의 일상이 된 작은 빵집
						</p>
					</a>
				</li>

...
function closeMainPopup(){
   $("#floating_banner").hide();
		...
		<div class="visual">
			...
			<h3>구매하기</h3>
			<p>
				<span>HOME</span> <span>구매하기</span> <strong>파바 딜리버리</strong>
			</p>
		</div>
		<!--visual-->
		...
		<div id="container">
			<aside>
				<ul>
					<li class="on"><a href="happyorder.pc">파바 딜리버리</a></li>
					<li><a href="happycon.pc">딜리버리 메뉴</a></li>
					<li><a href="happyday.pc">파바데이</a></li>
				</ul>
			</aside>

			<div class="contents">
				<div class="content content_01" style="margin-left:10%; max-width: 100%; height: auto;">
					<img src="resources/images/promotion/happyorder_img_01.jpg" alt="" />
					<a class="btn_01"
						href="https://happymarket.happypointcard.com/hm_front/app/deeplink?code=030&paramCode=파리바게뜨"
						onclick="ga('send', 'event', 'button', 'click', 'happyorder');"
						target="_blank"><img class="btn_01"
						src="resources/images/common/bg_blank.png" alt="해피오더 바로가기" /></a>
					<a class="btn_02" href="https://bit.ly/2KcK4tc"
						onclick="ga('send', 'event', 'button', 'click', 'yogiyo');"
						target="_blank"><img class="btn_02"
						src="resources/images/common/bg_blank.png" alt="요기요 바로가기" /></a> <a
						class="btn_03" href="https://goo.gl/jnzdgv"
						onclick="ga('send', 'event', 'button', 'click', 'baemin');"
						target="_blank"><img class="btn_03"
						src="resources/images/common/bg_blank.png" alt="배달의 민족 바로가기" /></a>
				</div>
				<!--content_01-->

				<div class="content content_02" id="searchshop">
					<div class="text_title" style="text-align:center;">파바 딜리버리 매장 찾기</div>

					<form name="form1" method="get">
						<div class="search_form_01">
							<div class="select_ui_box" id="d_sido" style="margin-left: 15%;">
								<select class="select_ui" style="width: 247px" id="s_sido"
									name="s_sido" onchange="callGugun();">
							...
							<div class="select_ui_box" id="d_gugun">
								<select class="select_ui" style="width: 247px" name="s_gugun"
									id="s_gugun" onchange="setGugun(this);">
									<option value="">시/구/군 선택</option>
								</select>
							</div>
							<div class="select_ui_box" id="d_deliver">
								<select class="select_ui" style="width: 150px" name="s_deliver"
									id="s_deliver">
							...
							<input type="text" class="inp" placeholder="주소, 매장명 검색"
								name="s_name" /> <a href="javascript:goSubmit();"><img
								src="resources/images/common/search_form_01_btn_search.gif"
								alt="검색" /></a>
						</div>
						<!--search_form_01-->
					</form>
					...
					<div class="list_style_02">
						<table border="0" cellspacing="0" cellpadding="0"
							...
							<tbody>
								...
								<tr>
									<td><a href="shop/search.jsp?id=NDU3NwEQUALEQUAL">PB올림픽</a></td>
									<td>서울 송파구 양재대로 1222 (방이동) 기자촌 중심상가 1층 90,91</td>
									<td>배달/픽업</td>
									<td>02-400-7844</td>
								</tr>
							</tbody>
...
.page_box .page_margin {
	overflow: hidden !important;
					...
					<div class='page_box'>
						<ul>
							<li><div class='page_first_btn' title='First Page'>
									<!---->
								</div></li>
							<li><div class='page_prev_btn' title='Previous 10 Pages'>
									<!---->
								</div></li>
							<li><div class='page_p_btn' title='Previous Page'>
									<!---->
								</div></li>
							<li class='page_margin'>&nbsp;</li>
							<li><div class='page_number_btn_on'>1</div></li>
							<li><div class='page_seperator'>
									<!---->
								</div></li>
							<li><a href='/purchase/happyorder.jsp?page=2'><div
										class='page_number_btn'>2</div></a></li>
							<li><div class='page_seperator'>
									<!---->
								</div></li>
							<li><a href='/purchase/happyorder.jsp?page=3'><div
										class='page_number_btn'>3</div></a></li>
							<li><div class='page_seperator'>
									<!---->
								</div></li>
							<li><a href='/purchase/happyorder.jsp?page=4'><div
										class='page_number_btn'>4</div></a></li>
							<li><div class='page_seperator'>
									<!---->
								</div></li>
							<li><a href='/purchase/happyorder.jsp?page=5'><div
										class='page_number_btn'>5</div></a></li>
							<li><div class='page_seperator'>
									<!---->
								</div></li>
							<li><a href='/purchase/happyorder.jsp?page=6'><div
										class='page_number_btn'>6</div></a></li>
							<li><div class='page_seperator'>
									<!---->
								</div></li>
							<li><a href='/purchase/happyorder.jsp?page=7'><div
										class='page_number_btn'>7</div></a></li>
							<li><div class='page_seperator'>
									<!---->
								</div></li>
							<li><a href='/purchase/happyorder.jsp?page=8'><div
										class='page_number_btn'>8</div></a></li>
							<li><div class='page_seperator'>
									<!---->
								</div></li>
							<li><a href='/purchase/happyorder.jsp?page=9'><div
										class='page_number_btn'>9</div></a></li>
							<li><div class='page_seperator'>
									<!---->
								</div></li>
							<li><a href='/purchase/happyorder.jsp?page=10'><div
										class='page_number_btn'>10</div></a></li>
							<li class='page_margin'>&nbsp;</li>
							<li><a href='/purchase/happyorder.jsp?page=2' class='on'><div
										class='page_n_btn' title='Next Page'>
										<!---->
									</div></a></li>
							<li><a href='/purchase/happyorder.jsp?page=11' class='on'><div
										class='page_next_btn' title='Next 10 Pages'>
										<!---->
									</div></a></li>
							<li><a href='/purchase/happyorder.jsp?page=489' class='on'><div
										class='page_last_btn' title='Last Page'>
										<!---->
									</div></a></li>
							<li
								style='clear: both; margin: 0px; padding: 0px; height: 0px; border-width: 0px; overflow-x: hidden; overflow-y: hidden;'></li>
						</ul>
					</div>
				</div>
				<!--content_02-->
		...
		<div id="footer">
			<footer>
				<div class="footer_link">
					<a href="http://www.spc.co.kr" target="_blank">회사소개</a> <a
						href="foundation/opening_merchant.jsp" target="_self">가맹점</a> <a
						href="http://happy.spc.co.kr" target="_blank">거래희망사전등록</a> <a
						href="https://www.happypointcard.com/serviceCenter/term1.spc"
						target="_blank">이용약관</a> <a href="etc/popEmail.jsp"
						target="_blank">이메일무단수집거부</a> <a href="etc/popPrivacy.jsp"
						target="_blank">개인정보처리방침</a> <a href="etc/popImgInfoPolicy.jsp"
						target="_blank">영상정보처리기기운영관리방침</a> <a
						href="http://www.spc.co.kr/spc/smile/group/GEM_info.spc"
						target="_blank">윤리신고센터</a> <a href="/customer/praise.jsp">고객센터</a>
				</div>
				<div class="recruit_info">
					<a href="#none" class="select_alink active">Recruit Info</a>
					<ul class="select_list" style="display: none;">
						<li><a href="http://www.pb-partners.co.kr/" target="_blank">샌드위치
								셰프모집</a></li>
						<li><a href="http://www.pb-partners.co.kr/" target="_blank">제빵기사
								취업전문</a></li>
				...
				<div class="footer_info_01">
					<div class="customer_info">
						<img src="resources/images/common/customer_num.gif"
							alt="080-731-2027 평일 09:00 - 17:00 (점심 12:00 - 13:00)" />
					</div>
					<div class="logo_info">
						<p>
							<a href="http://www.spc.co.kr/contributionAll" target="_blank"><img
								src="resources/images/common/footer_logo_img_01.gif" alt="" /></a>
						</p>
						<span><img
							src="resources/images/common/footer_logo_img_02.gif" alt="" /></span> <span><img
							src="resources/images/common/footer_logo_img_03.gif" alt="" /></span> <span><img
							src="resources/images/common/footer_logo_img_04.gif" alt="" /></span> <span><img
							src="resources/images/common/footer_logo_img_05.gif" alt="" /></span>
					</div>
					<div class="social_info">
						<a href="https://www.facebook.com/loveparisbaguette"
							target="_blank"><img
							src="resources/images/common/btn_social_01.gif" alt="페이스북" /></a> <a
							href="http://instagram.com/parisbaguette_kr" target="_blank"><img
							src="resources/images/common/btn_social_02.gif" alt="인스타그램" /></a> <a
							href="https://www.youtube.com/loveparisbaguette" target="_blank"><img
							src="resources/images/common/btn_social_03.gif" alt="유튜브" /></a>
					</div>
				</div>
				<!--footer_info_01-->
				<div class="footer_info_02">
					<address>
						경기도 성남시 중원구 상대원동 사기막골로 31번길 18 (주) 파리크라상<br /> All Rights Reserved
						&copy; PARIS BAGUETTE, PARIS CROISSANT CO., LTD.
					</address>
					<div class="brand_info">
						<a href="#none" class="select_alink active">Brand Site</a>
						<ul class="select_list" style="display: none">
							<li><strong>파리크라상</strong></li>
							<li><a href="http://www.pariscroissant.co.kr/"
								target="_blank" title="파리크라상">파리크라상</a></li>
							<li><a href="http://www.caffe-pascucci.co.kr/"
								target="_blank" title="파스쿠찌">파스쿠찌</a></li>
							<li><a href="http://www.pbchina.cn" target="_blank"
								title="파리바게뜨 중국">파리바게뜨 중국</a></li>
							<li><strong>비알코리아(주)</strong></li>
							<li><a href="http://www.baskinrobbins.co.kr/"
								target="_blank" title="배스킨라빈스">배스킨라빈스</a></li>
							<li><a href="http://www.dunkindonuts.co.kr/" target="_blank"
								title="던킨도너츠">던킨도너츠</a></li>
							<li><strong>기타</strong></li>
							<li><a href="http://www.shany.co.kr/" target="_blank"
								title="(주)샤니">(주)샤니</a></li>
							<li><a href="http://www.samlipgf.co.kr/" target="_blank"
								title="(주)삼립식품">(주)삼립식품</a></li>
							<li><a href="http://www.happypointcard.com/" target="_blank"
								title="해피포인트">해피포인트</a></li>
							<li><a href="http://dining.spc.co.kr/" target="_blank"
								title="SPC외식브랜드">SPC외식브랜드</a></li>
							<li><a href="http://www.dqueenscatering.com/"
								target="_blank" title="디퀸즈케이터링">디퀸즈케이터링</a></li>
						</ul>
					</div>
				</div>
				<!--footer_info_02-->
		...
		<noscript>
			<img src='http://gtb7.acecounter.com:8080/?uid=AH2A35661643126&je=n&'
				border=0 width=0 height=0 alt="에이스카운트" />
		</noscript>

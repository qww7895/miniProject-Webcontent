	...
	<div id="container">
		<aside>
			<ul>
				...
				<li class="on"><a href="happycon.pc">딜리버리 메뉴</a></li>
		...
		<div class="contents" style="padding:0;">
			<div class="content content_01" style="margin-left:10%; max-width: 100%; height: auto;">
				<img src=" resources/images/promotion/happycon_img_01.jpg" alt="" />
				<a href="https://bit.ly/2GBRZio" onclick="ga('send', 'event', 'button', 'click', 'happyorder');" class="link_01" target="_blank"><img src=" resources/images/bg_blank.png" alt="" /></a>
				<a href="https://bit.ly/2KcK4tc" onclick="ga('send', 'event', 'button', 'click', 'yogiyo');" class="link_02" target="_blank"><img src=" resources/images/bg_blank.png" alt="" /></a>
			</div><!--content_01-->
		</div><!--contents-->
	</div><!--container-->

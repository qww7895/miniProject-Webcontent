...
function closeMainPopup(){
   ...
   <div id="container">
      <aside>
         <ul>
            <li><a href="opening_merchant.fd">가맹점 개설</a></li>
            <li class="on"><a href="manager_recruit.fd">경영주 모집</a></li>
         </ul>
      </aside>
   
      <div class="contents">
         <div class="title">PB 임차형 가맹점 경영주 모집 안내</div>
         <div class="text_content text_content_01">
            <p>PB 임차형 가맹점 경영주은 일반 가맹점과는 다르게 본사가 모든 시설을 투자하여<br/>경영주에게 운영을 맡기고 수익을 분배하는 시스템으로 운영에 자신 있는 분들에게 추천합니다.</p>
            <div class="content_title">PB 임차형 가맹점 경영주의 특장점</div>
            <img src="resources/images/foundation/manager_recruit_img_01.gif" alt="PB 임차형 가맹점 경영주 특장점" />
            <div class="content_title">세부 투자 내역 <i>(VAT 제외)</i></div>
            <div class="table_text">
               <table border="0" cellspacing="0" cellpadding="0" summary="구분, 항목, 금액(천)">
                  <caption>세부 투자 내역</caption>
                  <colgroup>
                     <col width="293" />
                     <col width="412" />
                     <col width="413" />
         ...
         <div class="title">지원안내</div>
         <div class="text_content text_content_02">
            <p class="text_title_info"><strong>지원자격</strong> | 20~40대 남녀. 창의성 및 경영 마인드 소유자<br/><span>※ 현재 포항, 부산 지역 점포 운영가능자만 지원 가능합니다.</span></p>
            <div class="file_content">
               <strong>지원방법<br/>(온라인 지원)</strong>
               <p>
                  신청서 양식을 다운받아 작성 후, 메일로 보내주세요!
                  <i>· 메일주소 : startup@spc.co.kr</i>
               </p>
               <div class="btn_file">
                  <a href="/static/filedownload.jsp?key=1503539278.docx">임차형 창업희망자 신청서</a>&nbsp;
                  <a href="/static/filedownload.jsp?key=1503539267.docx">개인정보 수집동의서</a>
               </div>
               <span>※ 임차형 창업희망자 신청서 및 개인정보 수집동의서 2개 파일 필수 첨부!</span>
            </div>
            <div class="content_title">선발 절차</div>
            <img src="resources/images/foundation/manager_recruit_img_02.gif" alt="선발 절차" />
            <div class="inquiry_content">
               ...
               <div class="inquiry_info">
                  <strong>상담시간</strong>평일 10:30~17:00<br/>
                  <strong>방문주소</strong>서울시 서초구 남부순환로 2620 강남피타워
               </div>
            </div>
         </div><!-- text_content-->
      </div><!--contents-->

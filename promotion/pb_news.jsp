	...
	<div id="container">
		<aside>
			<ul>
				...
				<li class="on"><a href="pb_news.pr">PB 공지</a></li>
			</ul>
		</aside>

		<div class="contents">
			<div class="text_title_01">
				<span>총 32건</span>
				<!--//
				<p>
					<i><a href="pb_news.jsp" class="on">전체</a></i>
					
					<i><a href="pb_news.jsp?s_category_id=N001" class="">뉴스</a></i>
					
					<i><a href="pb_news.jsp?s_category_id=N002" class="">공지</a></i>
					
					<i><a href="pb_news.jsp?s_category_id=N003" class="">보도자료</a></i>
					
					<i><a href="pb_news.jsp?s_category_id=N004" class="">캠페인</a></i>
			...
			<div class="list_style_04">
				<ul>
					...
					<li>
						<a href="pb_news_view.pr?id=46&">
							<strong>공지</strong>
							<p>2019년 4월 1일 해피포인트 적립 정책 변경 안내</p>
							<span>2019.02.27</span>
						</a>
					</li>
					
					<li>
						<a href="pb_news_view.pr?id=45&">
							<strong>공지</strong>
							<p>파리바게뜨, 환경부와 1회용품 줄이기 자발적 협약</p>
							<span>2018.08.09</span>
						</a>
					</li>
					
					<li>
						<a href="pb_news_view.pr?id=41&">
							<strong>공지</strong>
							<p>2017년 6월 30일 해피포인트 소멸 관련 안내</p>
							<span>2017.06.14</span>
						</a>
					</li>
					
					<li>
						<a href="pb_news_view.pr?id=40&">
							<strong>뉴스</strong>
							<p>파리바게뜨 개인정보처리방침 개정안 공지</p>
							<span>2017.05.19</span>
						</a>
					</li>
					
					<li>
						<a href="pb_news_view.pr?id=39&">
							<strong>공지</strong>
							<p>시럽, 클립, 스마트월렛 해피포인트 서비스 종료</p>
							<span>2017.01.26</span>
						</a>
					</li>
					
					<li>
						<a href="pb_news_view.pr?id=38&">
							<strong>공지</strong>
							<p>10월 디저트/브레드 데이 미운영 공지</p>
							<span>2016.10.07</span>
						</a>
					</li>
					
					<li>
						<a href="pb_news_view.pr?id=34&">
							<strong>공지</strong>
							<p>파리바게뜨 홈페이지 서비스 이용 제한 안내</p>
							<span>2016.06.28</span>
						</a>
					</li>
					
					<li>
						<a href="pb_news_view.pr?id=33&">
							<strong>뉴스</strong>
							<p>해피포인트 소멸 관련 안내</p>
			...
			<style>.page_box { display:table; margin:0 auto; }.page_box ul { margin:0px; list-style:none; padding:0px; }.page_box li { float:left; margin:0px; padding:0px; }.page_box .page_margin { overflow:hidden !important; }</style><div class='page_box'><ul><li><div class='page_first_btn' title='First Page'><!----></div></li><li><div class='page_prev_btn' title='Previous 10 Pages'><!----></div></li><li><div class='page_p_btn' title='Previous Page'><!----></div></li><li class='page_margin'>&nbsp;</li><li><div class='page_number_btn_on'>1</div></li><li><div class='page_seperator'><!----></div></li><li><a href='/promotion/pb_news.jsp?page=2'><div class='page_number_btn'>2</div></a></li><li><div class='page_seperator'><!----></div></li><li><a href='/promotion/pb_news.jsp?page=3'><div class='page_number_btn'>3</div></a></li><li><div class='page_seperator'><!----></div></li><li><a href='/promotion/pb_news.jsp?page=4'><div class='page_number_btn'>4</div></a></li><li class='page_margin'>&nbsp;</li><li><a href='/promotion/pb_news.jsp?page=2' class='on'><div class='page_n_btn' title='Next Page'><!----></div></a></li><li><div class='page_next_btn' title='Next 10 Pages'><!----></div></li><li><a href='/promotion/pb_news.jsp?page=4' class='on'><div class='page_last_btn' title='Last Page'><!----></div></a></li><li style='clear:both; margin:0px; padding:0px; height:0px; border-width:0px; overflow-x:hidden; overflow-y:hidden;'></li></ul></div>
		</div><!--contents-->
	</div><!--container-->

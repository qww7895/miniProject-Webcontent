...
function closeMainPopup(){
   $("#floating_banner").hide();
	...
	<div id="container">
		...
		<aside>
			<ul>
				<li class="on"><a href="event.pr">이벤트</a></li>
		...
		<div class="content_01">
			<ul>
				...
				<li style="margin-left:10%;"><a href="https://www.paris.co.kr/promotion/event_view.pr?id=577"><img src="data/file/890772802856678adb55607d9e8cdca0.png" alt="요기요" /></a></li>
		...
		<div class="list_style_01">
			<ul>
				...
				<li>
					...
					<a href="event_view.pr?id=587">
					
						<img src="https://www.paris.co.kr/resources/images/event_img/event_190701/list2.jpg" alt="삼성카드 LINK 5천원 혜택!" />
						<p>
							<i class="period">~ 2019-08-29 <b>(D-57)</b></i>
							<span>삼성카드 LINK 5천원 혜택!</span>
							삼성카드 링크하면 매주 목요일 5천원 혜택!
						</p>
					</a>
				</li>
				...
				<li>
					...
					<a href="event_view.pr?id=586">
					
						<img src="https://www.paris.co.kr/resources/images/event_img/event_190701/list.jpg" alt="에스더 버니, 여름을 부탁해♥" />
						<p>
							<i class="period">~ 2019-07-31 <b>(D-28)</b></i>
							<span>에스더 버니, 여름을 부탁해♥</span>
							귀염뽀짝 선풍기&우산!파바에서 만나보세요 :)
						</p>
					</a>
				</li>
				...
				<li>
					...
					<a href="event_view.pr?id=585">
					
						<img src="https://www.paris.co.kr/resources/images/event_img/event_190627/list.jpg" alt="파리바게뜨 X 연플리 시즌4" />
						<p>
							<i class="period">~ 2019-08-31 <b>(D-59)</b></i>
							<span>파리바게뜨 X 연플리 시즌4</span>
							연플리 속 썸만큼이나달달~한 파바 제품들을 만나보세요♥
						</p>
					</a>
				</li>
				...
				<li>
					...
					<a href="event_view.pr?id=584">
					
						<img src="https://www.paris.co.kr/resources/images/event_img/event_190625/list.jpg" alt="파리바게뜨 핑크퐁 멜로디 우산♥" />
						<p>
							<i class="period">~ 2019-07-30 <b>(D-27)</b></i>
							<span>파리바게뜨 핑크퐁 멜로디 우산♥</span>
							비 오는 날만 기다려져!귀염뽀짝 핑크퐁 멜로디 우산!
						</p>
					</a>
				</li>
				...
				<li>
					...
					<a href="event_view.pr?id=581">
					
						<img src="https://www.paris.co.kr/resources/images/event_img/event_190529/list.jpg" alt="파리바게뜨 2019 여름페어!" />
						<p>
							<i class="period">~ 2019-08-31 <b>(D-59)</b></i>
							<span>파리바게뜨 2019 여름페어!</span>
							시원한 여름과일새콤달콤함에 물들다!
						</p>
					</a>
				</li>
				...
				<li>
					...
					<a href="event_view.pr?id=579">
					
						<img src="https://www.paris.co.kr/resources/images/event_img/event_190513/list2.jpg" alt="핫 써머! 후레쉬 빙수로 시원하게~" />
						<p>
							<i class="period">~ 2019-08-30 <b>(D-58)</b></i>
							<span>핫 써머! 후레쉬 빙수로 시원하게~</span>
							갑자기 분위기 여름?시원&달달 파바 빙수로 극.뽁♥
						</p>
					</a>
				</li>
				...
				<li>
					...
					<a href="event_view.pr?id=577">
					
						<img src="https://www.paris.co.kr/resources/images/event_img/event_190627/list2.png" alt="요기요 누구나 페스티벌, 파리바게뜨 최대 6,000원 혜택" />
						<p>
							<i class="period">~ 2019-07-05 <b>(D-2)</b></i>
							<span>요기요 누구나 페스티벌, 파리바게뜨 최대 6,000원 혜택</span>
							지금 요기요에서는?파리바게뜨 최대 6,000원 혜택 이벤트중!
						</p>
					</a>
				</li>
				...
				<li>
					...
					<a href="event_view.pr?id=575">
					
						<img src="https://www.paris.co.kr/resources/images/event_img/event_190605/list.jpg" alt="매일 저녁, 카카오페이로 톡 찍어 결제 시 최대 20% 혜택!" />
						<p>
							<i class="period">~ 2019-07-31 <b>(D-28)</b></i>
							<span>매일 저녁, 카카오페이로 톡 찍어 결제 시 최대 20% 혜택!</span>
							18시~21시!파바에서 카카오페이로 결제하고 최대 20% 혜택을 누리세요!
						</p>
					</a>
				</li>
				...
				<li>
					...
					<a href="event_view.pr?id=563">
					
						<img src="https://www.paris.co.kr/resources/images/event_img/event_190219/list1.png" alt="가장 신선하고 맛있는 시간 7-days" />
						<p>
							<i class="period">~ 2019-07-31 <b>(D-28)</b></i>
							<span>가장 신선하고 맛있는 시간 7-days</span>
							7일의 기다림이 만드는7일의 기적과 같은 맛♥
						</p>
					</a>
				</li>

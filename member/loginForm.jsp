...
function closeMainPopup(){
	...
	<div id="container">
		<div class="content">
			<div class="text_title">파리바게뜨 홈페이지의 <br/>로그인 창입니다.</div>
			<form name="loginform" method="post" action="MemberLoginAction.log">
			<input type="hidden" name="issacweb_data" value="" />
			<input type="hidden" name="challenge" value="" />
			<input type="hidden" name="response" value="" />
			<div class="login_form">
				<ul>
					<li><input type="text" placeholder="아이디" id="MID" name="MID" /></li>
					<li><input type="password" placeholder="비밀번호" id="MPW" name="MPW" onKeyDown="javascript:if(event.keyCode==13){idpwLogin();}" /></li>
				</ul>
				<a href="javascript:loginform.submit()" class="btn_login">로그인</a>
				<div class="checkbox_ui">
					<p><input type="checkbox" class="inp_checkbox" id="checkbox_01" name="name_checkbox" checked /><label for="checkbox_01">아이디 저장</label></p>
				</div>
				<div class="btn_link">
					<a href="https://member.happypointcard.com/member_02/join_03.html?url_check=HPC">아이디 찾기</a>
					<span><a href="https://member.happypointcard.com/member_02/join_04_real.html?url_check=HPC">비밀번호 재발급</a></span>
				</div>
			</div>
			<div class="spc_login">
				<p>파리크라상 & 비알코리아 회원으로 가입하시면<br/>해피포인트카드, 파리크라상, 파리바게뜨, 배스킨라빈스, 던킨도너츠, 파스쿠찌, 해피이샵, 잠바주스, <br/>헬륨 등 SPC에서 운영하는 웹사이트의 서비스를 하나의 아이디 비밀번호로 이용하실 수 있습니다.</p>
				<a href="MemberJoin.log">파리바게뜨 회원 가입</a>
			</div>

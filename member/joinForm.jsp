...
/* function closeMainPopup(){
   ...
   <div id="container">
      <div class="content">
         <div class="text_title">파리바게뜨에 오신 것을 환영합니다</div>
         <form name="joinform" method="post" action="MemberJoinAction.log">
         ...
         <div class="login_form">
            <ul>
	            <li><input type="text" placeholder="아이디"  		id="MID"   name="MID"   /></li>
     	        <li><input type="password" placeholder="비밀번호"  id="MPW"   name="MPW"   /></li>
                <li><input type="text" placeholder="이름"  		id="MNAME"  name="MNAME" /></li>
                <li><input type="text" placeholder="주민등록번호"   id="MHNUM"  name="MHNUM" /></li>
                <li><input type="text" placeholder="전화번호"      id="MTELL" name="MTELL" /></li>
                <li><input type="text" placeholder="이메일"       id="MMAIL" name="MMAIL" /></li>
               
            </ul>
            <a href="javascript:joinform.submit();" class="btn_login">회원가입</a><br>
            <a href="javascript:joinform.reset();" class="btn_login">다시입력</a>
         </div>
